...
; CHECK: %0 = load i32, i32* %a, align 4, !errorprop.abserror !8
; CHECK: %1 = load i32, i32* %b, align 4, !errorprop.abserror !8
; CHECK: %add = add nsw i32 %0, %1, !errorprop.range !9, !errorprop.abserror !10
; CHECK: %2 = load i32, i32* %a, align 4, !errorprop.abserror !10
; CHECK: %shl = shl i32 %2, 3, !errorprop.range !11, !errorprop.abserror !10
; CHECK: %3 = load i32, i32* %a, align 4, !errorprop.abserror !10
; CHECK: %4 = load i32, i32* %b, align 4, !errorprop.abserror !8
; CHECK: %sub = sub nsw i32 %3, %4, !errorprop.range !12, !errorprop.abserror !8
; CHECK: %5 = load i32, i32* %b, align 4, !errorprop.abserror !8
; CHECK: %shr = ashr i32 %5, 3, !errorprop.range !13, !errorprop.abserror !14
; CHECK: %6 = load i32, i32* %a, align 4, !errorprop.abserror !10
; CHECK: %7 = load i32, i32* %b, align 4, !errorprop.abserror !14
; CHECK: %mul = mul nsw i32 %6, %7, !errorprop.range !15, !errorprop.abserror !3
; CHECK: %8 = load i32, i32* %b, align 4, !errorprop.abserror !14
; CHECK: %9 = load i32, i32* %a, align 4, !errorprop.abserror !3
; CHECK: %div = sdiv i32 %8, %9, !errorprop.range !16, !errorprop.abserror !4
; CHECK: %10 = load i32, i32* %b, align 4, !errorprop.abserror !4
...
; CHECK: !3 = !{double 0x3FD2F40000000000}
; CHECK: !4 = !{double 0x3FE065121211F59A}
; CHECK: !6 = !{double 0.000000e+00}
; CHECK: !8 = !{double 3.125000e-02}
; CHECK: !10 = !{double 6.250000e-02}
; CHECK: !14 = !{double 2.812500e-01}