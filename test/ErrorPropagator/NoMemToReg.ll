...
; CHECK: %a.addr = alloca i32, align 4, !errorprop.abserror !10
; CHECK: %b.addr = alloca i32, align 4, !errorprop.abserror !11
; CHECK: %0 = load i32, i32* %a.addr, align 4, !errorprop.abserror !6
; CHECK: %1 = load i32, i32* %b.addr, align 4, !errorprop.abserror !9
; CHECK: %add = add nsw i32 %0, %1, !errorprop.range !12, !errorprop.abserror !13
; CHECK: %2 = load i32, i32* %a.addr, align 4, !errorprop.abserror !13
; CHECK: %3 = load i32, i32* %b.addr, align 4, !errorprop.abserror !9
; CHECK: %sub = sub nsw i32 %2, %3, !errorprop.range !14, !errorprop.abserror !6
; CHECK: %4 = load i32, i32* %a.addr, align 4, !errorprop.abserror !13
; CHECK: %5 = load i32, i32* %b.addr, align 4, !errorprop.abserror !6
; CHECK: %mul = mul nsw i32 %4, %5, !errorprop.range !15, !errorprop.abserror !10
; CHECK: %6 = load i32, i32* %b.addr, align 4, !errorprop.abserror !6
; CHECK: %7 = load i32, i32* %a.addr, align 4, !errorprop.abserror !10
; CHECK: %div = sdiv i32 %6, %7, !errorprop.range !16, !errorprop.abserror !11
; CHECK: %8 = load i32, i32* %b.addr, align 4, !errorprop.abserror !11
...
; CHECK: !14 = !{i32 5, i32 4, i32 16}
; CHECK: !15 = !{i32 5, i32 72, i32 416}
; CHECK: !16 = !{i32 5, i32 0, i32 0}
